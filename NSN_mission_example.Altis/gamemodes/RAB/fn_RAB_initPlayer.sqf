/*
  - FUNCION QUE SE ENCARGA DE TODO LO QUE VE EL JUGADOR EN ESTE MODO DE JUEGO-
            - USO INTERNO DE RAB -
...
private _pos2marker = (_zonas apply {getMarkerPos _x})  createHashMapFromArray _zonas;
_advertencia = 0;
